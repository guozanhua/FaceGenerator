...
void glut_display(){
    ...
    GLfloat lightpos1[]={static_cast<GLfloat>(5 * cos(g_angle4) * sin(g_angle3)),
        static_cast<GLfloat>(5 * sin(g_angle4)),
        static_cast<GLfloat>(5 * cos(g_angle4) * cos(g_angle3)),
        1.0};
    GLfloat diffuse1[] = {0.0, 1.0, 1.0, 1.0};
    GLfloat lightpos2[]={static_cast<GLfloat>(5 * cos(g_angle4) * sin(g_angle3)-0.5),
        static_cast<GLfloat>(5 * sin(g_angle4)-0.5),
        static_cast<GLfloat>(5 * cos(g_angle4) * cos(g_angle3)-0.5),
        1.0};
    GLfloat diffuse2[] = {0.0, 1.0, 0.0, 0.5};
    ...
    glPushMatrix();
    glTranslatef(5 * cos(g_angle4) * sin(g_angle3)-0.5, 5 * sin(g_angle4)-0.5,
                 5 * cos(g_angle4) * cos(g_angle3)-0.5);
    glutSolidSphere(0.2, 50, 50);
    glPopMatrix();
