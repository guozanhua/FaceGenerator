...
int main(int argc, char** argv){
    ...
    printf("deteced faces:%d\n",(int)faces2.size());//TODO:読み込めない時の処理
    for (int i=0; i<1; i++) {
        //saturate_castについては　http://opencv.jp/opencv-2svn/cpp/operations_on_arrays.html
        //顔全体の矩形の確定
        ...
        cv::CascadeClassifier nested_cascade_eye;
        cv::CascadeClassifier nested_cascade_nose;
        cv::CascadeClassifier nested_cascade_mouth;
        ...
        std::vector<cv::Rect> nose_areas;
        std::vector<cv::Rect> mouth_areas;
        ///目の検出
